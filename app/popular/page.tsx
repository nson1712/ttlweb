...
export default function PopularPage() {
  ...
  // Filter novels based on search query, genre, and status
  const filteredNovels = novels.filter((novel) => {
    const matchesSearch =
      novel.title.toLowerCase().includes(searchQuery.toLowerCase()) ||
      novel.author.toLowerCase().includes(searchQuery.toLowerCase());
    const matchesGenre =
      selectedGenre === "all" || novel.genres.includes(selectedGenre);
    const matchesStatus =
      selectedStatus === "all" ||
      novel.status.toLowerCase() === selectedStatus.toLowerCase();
...
const featuredNovel: Novel = {
  ...
  genres: ["Fantasy", "Mystery", "Steampunk", "Adventure"],
  description:
...
const novels: Novel[] = [
  {
    ...
    genres: ["Fantasy", "Mystery", "Steampunk", "Adventure"],
    description:
      "Waking up to be faced with a string of mysteries, Zhou Mingrui finds himself reincarnated as Klein Moretti in an alternate Victorian era world.",
    featured: true,
  },
  {
    id: "shadow-slave",
    ...
    title: "Shadow Slave",
    coverImage:
      "https://static.wikia.nocookie.net/shadowslave/images/e/e3/Shadow_Slave_Cover.jpg",
    author: "Guilty",
    rating: 4.7,
    totalRatings: 8765,
    views: 7654321,
  ...
  },
  {
    ...
    title: "Supreme Magus",
    coverImage:
      "https://m.media-amazon.com/images/I/51JcSqV9YVL._SY445_SX342_.jpg",
    author: "Legion20",
    rating: 4.6,
    totalRatings: 7654,
    views: 6543210,
    ...
    genres: ["Fantasy", "Adventure", "Magic", "Romance"],
    description:
      "Derek McCoy was a man who spent his entire life facing adversity and injustice. After being forced to settle with surviving rather than living, he had finally found his place in the world, until everything was taken from him one last time.",
  },
  {
    ...
    coverImage:
      "https://m.media-amazon.com/images/I/51JQW6mzBTL._SY445_SX342_.jpg",
    author: "Gu Zhen Ren",
    rating: 4.8,
    totalRatings: 9876,
    views: 5432109,
    ...
    genres: ["Fantasy", "Cultivation", "Action", "Mature"],
    description:
      "A story of a villain, Fang Yuan who was reborn 500 years into the past with the Spring Autumn Cicada he painstakingly refined. With his profound wisdom, battle and life experiences, he seeks to overcome his foes while advancing to the highest level.",
  },
  {
    ...
    genres: ["Sci-Fi", "Adventure", "Fantasy", "Virtual Reality"],
    description:
  ...
  },
  {
    ...
    genres: ["Fantasy", "Adventure", "Apocalypse", "Action"],
    description:
  ...
  },
  {
    ...
    description:
      "King Grey has unrivaled strength, wealth, and prestige in a world governed by martial ability. However, solitude lingers closely behind those with great power. Beneath the glamorous exterior of a powerful king lurks the shell of man.",
  },
  {
    ...
    status: "Completed",
    lastUpdated: "1 year ago",
    genres: ["Fantasy", "Kingdom Building", "Magic", "Romance"],
    description:
      "Chen Yan travels through time, only to end up becoming an honorable prince in the Middle Ages of Europe. Yet this world was not quite as simple as he thought.",
  },
  {
    ...
    genres: ["Fantasy", "Magic", "Adventure", "Mature"],
    description:
      "What happens when a scientist from a futuristic world reincarnates in a World of Magic and Knights? An awesome MC is what happens!",
  },
  {
