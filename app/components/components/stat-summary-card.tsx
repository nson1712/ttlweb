        ...
        <div className="relative bg-majestic-card rounded-xl p-6 border border-gray-800 hover:border-emerald-500/30 transition-all duration-300">
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="text-gray-400 text-sm">
              <span className="font-medium text-emerald-500">2999</span>
          ...
          <div className="mt-4 pt-4 border-t border-gray-800">
            ...
            <div className="flex space-x-3">
              <div className="bg-gray-800 p-2 rounded-md border border-gray-700 group hover:border-emerald-500/50 transition-all duration-300 hover:bg-gray-800/80">
                <div className="text-xs text-center text-gray-400 mb-1">Premium Chapter</div>
                <div className="h-10 w-10 relative flex items-center justify-center">
                  <BookOpen className="h-6 w-6 text-emerald-500 group-hover:scale-110 transition-transform duration-300" />
                </div>
              </div>
              ...
              <div className="bg-gray-800 p-2 rounded-md border border-gray-700 group hover:border-emerald-500/50 transition-all duration-300 hover:bg-gray-800/80">
                ...
                <div className="h-10 w-10 relative flex items-center justify-center">
                  <span className="text-emerald-500 font-bold group-hover:scale-110 transition-transform duration-300">✦</span>
                </div>
              </div>
              ...
              <div className="bg-gray-800 p-2 rounded-md border border-gray-700 group hover:border-emerald-500/50 transition-all duration-300 hover:bg-gray-800/80">
                ...
                <div className="h-10 w-10 relative flex items-center justify-center">
                  <Clock className="h-6 w-6 text-emerald-500 group-hover:scale-110 transition-transform duration-300" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="relative">
        ...
        <div className="relative bg-majestic-card rounded-xl p-6 border border-gray-800 hover:border-emerald-500/30 transition-all duration-300">
          ...
          <div className="flex space-x-4">
            <div className="relative w-20 h-28 rounded-md overflow-hidden border border-gray-700 group-hover:border-emerald-500/50 transition-colors">
              <Image 
                src="/novel-cover.jpg" 
                alt="Novel Cover" 
                layout="fill" 
            ...
            <div className="flex-1">
              <h4 className="text-emerald-400 font-medium mb-1">The Shadow Throne</h4>
              ...
              <div className="mt-3">
                <button className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white text-sm font-medium py-1 px-3 rounded-md transition-all duration-300 transform hover:scale-105">
                  Continue Reading
                </button>
              </div>
            </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        {statsCards.map((card) => (
          ...
          >
            ...
            <div className="relative bg-majestic-card rounded-lg p-4 border border-gray-700 group-hover:border-emerald-500/30 transition-all duration-300 hover-scale">
              <div className="flex justify-between items-center mb-2">
                ...
                <div className={`${card.iconBg} p-1 rounded group-hover:bg-opacity-80 transition-all duration-300`}>
                  {card.id === 1 && <BookOpen className="h-5 w-5 text-emerald-500 group-hover:scale-110 transition-transform duration-300" />}
                  {card.id === 2 && <Clock className="h-5 w-5 text-emerald-500 group-hover:scale-110 transition-transform duration-300" />}
                  {card.id === 3 && <Star className="h-5 w-5 text-emerald-500 group-hover:scale-110 transition-transform duration-300" />}
                  {card.id === 4 && <Award className="h-5 w-5 text-emerald-500 group-hover:scale-110 transition-transform duration-300" />}
                </div>
              </div>
              ...
              {/* Decorative elements */}
              <div className="absolute bottom-1 right-1 h-8 w-8 bg-gradient-to-br from-gray-700/20 to-gray-800/20 rounded-full blur-sm group-hover:bg-gradient-to-br group-hover:from-emerald-500/10 group-hover:to-emerald-600/10 transition-all duration-500"></div>
            </div>
          </div>
        ))}
      </div>
